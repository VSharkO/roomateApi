...
class StatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create status" do
    assert_difference('Status.count') do
      post statuses_url, params: { status: { boolean: @status.boolean, isActive: @status.isActive } }
    end
  ...
  test "should update status" do
    patch status_url(@status), params: { status: { boolean: @status.boolean, isActive: @status.isActive } }
